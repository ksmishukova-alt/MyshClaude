...
-- ─────────────────────────────────────────────
-- ОБНОВЛЕНИЕ v2: «Головы и ноги» — ОДНА задача «Звери и птицы» на всех уровнях
-- (метод предположения, экраны-шаги, AssumptionRunner). Перекрывает старые
-- демо-задачи (Зайцы и змеи / Овцы и гуси / Машины / Пауки). Идемпотентно.
-- ─────────────────────────────────────────────
update olympiad_themes set data =
 '{"id":"heads-legs","title":"Головы и ноги","blurb":"Метод предположения: «представим, что все одинаковые» и сравним.","icon":"🐰","dependsOn":["search"],"levels":["L1","L2","L3","L4","L5"],"masteryLevel":"L4","skillTags":["метод предположения","уравнивание"],"method":{"title":"Метод предположения","intro":"Когда есть два вида и известны «головы» и «ноги», удобно сначала представить, что все одного вида, а потом сравнить с настоящим числом ног.","steps":["Предположи, что ВСЕ одного вида (обычно — у кого ног меньше).","Посчитай, сколько было бы ног при таком предположении.","Сравни с настоящим числом ног — найди разницу.","Каждая замена одного вида на другой добавляет фиксированное число ног. Раздели разницу на эту «добавку» — получишь, сколько заменить."],"example":"8 голов, 20 ног, зайцы(4)/змеи(0). Все змеи → 0 ног. Разница 20. Замена даёт +4. 20÷4 = 5 зайцев, значит 3 змеи."}}'
 where id = 'heads-legs';

insert into olympiad_problems (id, theme_id, level, ord, reward_stars, data) values
 ('hl-l1-1','heads-legs','L1',1,15,'{"id":"hl-l1-1","themeId":"heads-legs","level":"L1","title":"Звери и птицы","statement":"В зоопарке живут четвероногие звери и двуногие птицы. В зоопарке 30 голов и 100 ног. Сколько зверей и сколько птиц живёт в зоопарке?","expectedAnswer":"20 зверей, 10 птиц","acceptedAnswers":["20 и 10","20 зверей 10 птиц","зверей 20 птиц 10"],"hints":["Представь, что все 30 — птицы (у них ног меньше). Сколько тогда ног?","Сравни с 100 — на сколько не хватает?","Один зверь добавляет 4 − 2 = 2 ноги. Раздели разницу на 2."],"rewardStars":15,"skillTags":["метод предположения","уравнивание"],"assumption":{"participants":[{"key":"zveri","label":"звери","countLabel":"зверей","one":"зверь","icon":"🦁","legs":4},{"key":"ptici","label":"птицы","countLabel":"птиц","one":"птица","icon":"🐦","legs":2}],"totalHeads":30,"totalLegs":100,"legUnit":"ног","headUnit":"голов"},"breakdown":{"known":"30 голов, 100 ног. У зверя 4 ноги, у птицы 2.","idea":"Представим, что все — птицы (у них ног меньше), и сравним со 100.","steps":["Все 30 — птицы: 30 × 2 = 60 ног.","Не хватает: 100 − 60 = 40 ног.","Зверь добавляет 4 − 2 = 2 ноги: 40 ÷ 2 = 20 зверей.","Птиц: 30 − 20 = 10."],"writtenSolution":"Все птицы → 60 ног. Не хватает 40. Каждый зверь добавляет 2: 40 ÷ 2 = 20 зверей, 30 − 20 = 10 птиц.","answer":"20 зверей и 10 птиц.","selfCheck":"20 × 4 + 10 × 2 = 80 + 20 = 100 ног, 20 + 10 = 30 голов. Сходится!"}}'),
 ('hl-l2-1','heads-legs','L2',1,18,'{"id":"hl-l2-1","themeId":"heads-legs","level":"L2","title":"Звери и птицы","statement":"В зоопарке живут четвероногие звери и двуногие птицы. В зоопарке 30 голов и 100 ног. Сколько зверей и сколько птиц живёт в зоопарке?","expectedAnswer":"20 зверей, 10 птиц","acceptedAnswers":["20 и 10","20 зверей 10 птиц","зверей 20 птиц 10"],"hints":["Представь, что все 30 — птицы (у них ног меньше). Сколько тогда ног?","Сравни с 100 — на сколько не хватает?","Один зверь добавляет 4 − 2 = 2 ноги. Раздели разницу на 2."],"rewardStars":18,"skillTags":["метод предположения","уравнивание"],"assumption":{"participants":[{"key":"zveri","label":"звери","countLabel":"зверей","one":"зверь","icon":"🦁","legs":4},{"key":"ptici","label":"птицы","countLabel":"птиц","one":"птица","icon":"🐦","legs":2}],"totalHeads":30,"totalLegs":100,"legUnit":"ног","headUnit":"голов"},"breakdown":{"known":"30 голов, 100 ног. У зверя 4 ноги, у птицы 2.","idea":"Представим, что все — птицы (у них ног меньше), и сравним со 100.","steps":["Все 30 — птицы: 30 × 2 = 60 ног.","Не хватает: 100 − 60 = 40 ног.","Зверь добавляет 4 − 2 = 2 ноги: 40 ÷ 2 = 20 зверей.","Птиц: 30 − 20 = 10."],"writtenSolution":"Все птицы → 60 ног. Не хватает 40. Каждый зверь добавляет 2: 40 ÷ 2 = 20 зверей, 30 − 20 = 10 птиц.","answer":"20 зверей и 10 птиц.","selfCheck":"20 × 4 + 10 × 2 = 80 + 20 = 100 ног, 20 + 10 = 30 голов. Сходится!"}}'),
 ('hl-l3-1','heads-legs','L3',1,22,'{"id":"hl-l3-1","themeId":"heads-legs","level":"L3","title":"Звери и птицы","statement":"В зоопарке живут четвероногие звери и двуногие птицы. В зоопарке 30 голов и 100 ног. Сколько зверей и сколько птиц живёт в зоопарке?","expectedAnswer":"20 зверей, 10 птиц","acceptedAnswers":["20 и 10","20 зверей 10 птиц","зверей 20 птиц 10"],"hints":["Представь, что все 30 — птицы (у них ног меньше). Сколько тогда ног?","Сравни с 100 — на сколько не хватает?","Один зверь добавляет 4 − 2 = 2 ноги. Раздели разницу на 2."],"rewardStars":22,"skillTags":["метод предположения","уравнивание"],"assumption":{"participants":[{"key":"zveri","label":"звери","countLabel":"зверей","one":"зверь","icon":"🦁","legs":4},{"key":"ptici","label":"птицы","countLabel":"птиц","one":"птица","icon":"🐦","legs":2}],"totalHeads":30,"totalLegs":100,"legUnit":"ног","headUnit":"голов"},"breakdown":{"known":"30 голов, 100 ног. У зверя 4 ноги, у птицы 2.","idea":"Представим, что все — птицы (у них ног меньше), и сравним со 100.","steps":["Все 30 — птицы: 30 × 2 = 60 ног.","Не хватает: 100 − 60 = 40 ног.","Зверь добавляет 4 − 2 = 2 ноги: 40 ÷ 2 = 20 зверей.","Птиц: 30 − 20 = 10."],"writtenSolution":"Все птицы → 60 ног. Не хватает 40. Каждый зверь добавляет 2: 40 ÷ 2 = 20 зверей, 30 − 20 = 10 птиц.","answer":"20 зверей и 10 птиц.","selfCheck":"20 × 4 + 10 × 2 = 80 + 20 = 100 ног, 20 + 10 = 30 голов. Сходится!"}}'),
 ('hl-l4-1','heads-legs','L4',1,28,'{"id":"hl-l4-1","themeId":"heads-legs","level":"L4","title":"Звери и птицы","statement":"В зоопарке живут четвероногие звери и двуногие птицы. В зоопарке 30 голов и 100 ног. Сколько зверей и сколько птиц живёт в зоопарке?","expectedAnswer":"20 зверей, 10 птиц","acceptedAnswers":["20 и 10","20 зверей 10 птиц","зверей 20 птиц 10"],"hints":["Представь, что все 30 — птицы (у них ног меньше). Сколько тогда ног?","Сравни с 100 — на сколько не хватает?","Один зверь добавляет 4 − 2 = 2 ноги. Раздели разницу на 2."],"rewardStars":28,"skillTags":["метод предположения","уравнивание"],"assumption":{"participants":[{"key":"zveri","label":"звери","countLabel":"зверей","one":"зверь","icon":"🦁","legs":4},{"key":"ptici","label":"птицы","countLabel":"птиц","one":"птица","icon":"🐦","legs":2}],"totalHeads":30,"totalLegs":100,"legUnit":"ног","headUnit":"голов"},"breakdown":{"known":"30 голов, 100 ног. У зверя 4 ноги, у птицы 2.","idea":"Представим, что все — птицы (у них ног меньше), и сравним со 100.","steps":["Все 30 — птицы: 30 × 2 = 60 ног.","Не хватает: 100 − 60 = 40 ног.","Зверь добавляет 4 − 2 = 2 ноги: 40 ÷ 2 = 20 зверей.","Птиц: 30 − 20 = 10."],"writtenSolution":"Все птицы → 60 ног. Не хватает 40. Каждый зверь добавляет 2: 40 ÷ 2 = 20 зверей, 30 − 20 = 10 птиц.","answer":"20 зверей и 10 птиц.","selfCheck":"20 × 4 + 10 × 2 = 80 + 20 = 100 ног, 20 + 10 = 30 голов. Сходится!"}}'),
 ('hl-l5-1','heads-legs','L5',1,40,'{"id":"hl-l5-1","themeId":"heads-legs","level":"L5","title":"Звери и птицы","statement":"В зоопарке живут четвероногие звери и двуногие птицы. В зоопарке 30 голов и 100 ног. Сколько зверей и сколько птиц живёт в зоопарке? Реши на листочке, сфотографируй и впиши ответ.","expectedAnswer":"20 зверей, 10 птиц","acceptedAnswers":["20 и 10","20 зверей 10 птиц","зверей 20 птиц 10"],"hints":[],"rewardStars":40,"skillTags":["метод предположения","уравнивание"],"assumption":{"participants":[{"key":"zveri","label":"звери","countLabel":"зверей","one":"зверь","icon":"🦁","legs":4},{"key":"ptici","label":"птицы","countLabel":"птиц","one":"птица","icon":"🐦","legs":2}],"totalHeads":30,"totalLegs":100,"legUnit":"ног","headUnit":"голов"},"breakdown":{"known":"30 голов, 100 ног. У зверя 4 ноги, у птицы 2.","idea":"Представим, что все — птицы (у них ног меньше), и сравним со 100.","steps":["Все 30 — птицы: 30 × 2 = 60 ног.","Не хватает: 100 − 60 = 40 ног.","Зверь добавляет 4 − 2 = 2 ноги: 40 ÷ 2 = 20 зверей.","Птиц: 30 − 20 = 10."],"writtenSolution":"Все птицы → 60 ног. Не хватает 40. Каждый зверь добавляет 2: 40 ÷ 2 = 20 зверей, 30 − 20 = 10 птиц.","answer":"20 зверей и 10 птиц.","selfCheck":"20 × 4 + 10 × 2 = 80 + 20 = 100 ног, 20 + 10 = 30 голов. Сходится!"}}')
on conflict (id) do update set
  theme_id = excluded.theme_id, level = excluded.level, ord = excluded.ord,
  reward_stars = excluded.reward_stars, data = excluded.data;
